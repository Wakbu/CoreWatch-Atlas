...
public sealed record AlertRule(long Id, string Name, string MetricType, double Threshold, string Severity, bool Enabled, int DurationSeconds=0, int RenotifyMinutes=0, int EscalateMinutes=0, string? Assignee=null, Guid? TargetAgentId=null, long? TargetGroupId=null, string? DiagnosticId=null);
public sealed record AlertRuleRequest(string Name, string MetricType, double Threshold, string Severity, bool Enabled, int DurationSeconds=0, int RenotifyMinutes=0, int EscalateMinutes=0, string? Assignee=null, Guid? TargetAgentId=null, long? TargetGroupId=null, string? DiagnosticId=null);
